  ...
  return (
    ...
    >
      ...
      >
        ...
        <header
          className="staggered-menu-header pointer-events-none absolute top-0 left-0 z-20 flex w-full items-center justify-between bg-transparent p-[2em] align-middle"
